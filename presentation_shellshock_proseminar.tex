...
\begin{frame}{Ungepatchte Bash}
  \begin{block}{Angriff in der Praxis}
    \begin{itemize}[<+->]
      \item In der Praxis nicht ganz so einfach durchführbar,
      \item da ein Angreifer für gewöhnlich keinen Zugriff auf die Shell hat
      \item Allerdings tauschen viele Anwendungen Informationen mittels Variablen über die Shell aus
      \begin{itemize}[<+->]
